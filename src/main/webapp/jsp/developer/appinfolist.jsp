					...
					<a href="${pageContext.request.contextPath}/jsp/developer/appinfoadd.jsp" class="btn btn-success btn-sm">新增APP基础信息</a>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a  class="modifyAppInfo" 
											...
											data-toggle="tooltip" data-placement="top" title="${appInfo.statusname}" data-original-title="修改APP基础信息">修改</a></li>
						...
						<li><a  class="deleteApp" appinfoid=${appInfo.id }  appsoftwarename= data-toggle="tooltip" data-placement="top" title="" data-original-title="删除APP基础信息以及全部版本信息">删除</a></li>
                      </ul>
                    </div>
										</td>
									</tr>
